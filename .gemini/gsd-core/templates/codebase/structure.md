...
- Usage: Reference from command with `@/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/jgm/dev/projects/web-projects/panelito/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jgm/dev/projects/web-projects/panelito/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
