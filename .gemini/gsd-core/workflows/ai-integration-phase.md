...
<required_reading>
@/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/references/ai-frameworks.md
@/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/jgm/dev/projects/web-projects/panelito/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/jgm/dev/projects/web-projects/panelito/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/jgm/dev/projects/web-projects/panelito/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/jgm/dev/projects/web-projects/panelito/.gemini/agents/gsd-eval-planner.md for instructions.
