...
ones). Reference: @/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/jgm/dev/projects/web-projects/panelito/.gemini.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/jgm/dev/projects/web-projects/panelito/.gemini/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/templates/spec.md.
