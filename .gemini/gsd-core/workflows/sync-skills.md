...
INSTALL_JS_GLOBAL="/home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/jgm/dev/projects/web-projects/panelito/.gemini/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
