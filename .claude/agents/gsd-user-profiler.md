...
<reference>
@/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/references/user-profiling.md` to load:
