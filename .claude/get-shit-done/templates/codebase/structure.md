...
- Usage: Reference from command with `@/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/jgm/dev/projects/web-projects/panelito/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jgm/dev/projects/web-projects/panelito/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
