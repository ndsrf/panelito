...
```
Agent(
  prompt="Read /home/jgm/dev/projects/web-projects/panelito/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/templates/SECURITY.md`
