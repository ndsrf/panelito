...
```bash
INIT=$(node "/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/templates/spec.md.
