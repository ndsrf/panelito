...
```markdown
Read /home/jgm/dev/projects/web-projects/panelito/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/jgm/dev/projects/web-projects/panelito/.claude/agents/gsd-ui-checker.md for instructions.
