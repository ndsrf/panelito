...
- **Global scope**: `/home/jgm/dev/projects/web-projects/panelito/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jgm/dev/projects/web-projects/panelito/.claude/notes/`)
...
2. Glob `/home/jgm/dev/projects/web-projects/panelito/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/jgm/dev/projects/web-projects/panelito/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jgm/dev/projects/web-projects/panelito/.claude/notes/` — works in any directory
