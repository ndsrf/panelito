...
```bash
INIT=$(node "/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/jgm/dev/projects/web-projects/panelito/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
